...
int main(int argc, char **argv)
{
	 ...
	 * Usage: 
	 * ./extract_stride_data <ifile_name> <output_peaks_x> <output_waveform_x> 
	 * <output_peaks_y> <output_waveform_y> <output_peaks_z> <output_waveform_z> <threshold_value>
	 */
...
//		printf("reading line\n");
	 ...
	 */
	//printf("Thresholds for X axis signal: %f Y axis signal: %f Z axis signal: %f\n", pk_threshold_x, pk_threshold_y, pk_threshold_z);
