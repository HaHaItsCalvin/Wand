...
./all_waveform_peak_find $1 waveform_peaks_output_x.csv waveform_gnuplot_x.csv waveform_peaks_output_y.csv waveform_gnuplot_y.csv waveform_peaks_output_z.csv waveform_gnuplot_z.csv $2 $3 $4
