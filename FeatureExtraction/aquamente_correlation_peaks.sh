...
sh find_1ZZ_peaks.sh ~/Wand/aquamente/Xcorr_data/aquamente_xcorr_$peak_number $X_thresh $Y_thresh 
while true
do

cp waveform_peaks_output_x.csv ~/Wand/aquamente/Xcorr_data/peaks/autocorr_peaks/aquamente_xxpeaks_$peak_number.csv
